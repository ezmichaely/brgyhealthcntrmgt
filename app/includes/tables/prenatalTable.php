        ...
        <div class="bg-white rounded border-start border-3 border-success p-3">
            ...
            <div class="mt-3 d-flex justify-content-between align-items-center flex-row flex-wrap">
                ...
                <button type="button" class="btn btn-success font-title fw-bold text-uppercase" data-bs-toggle="modal"
                    data-bs-target="#addModalPrenatal">
                    <i class="fas fa-plus"></i>
                    <span class="ms-1">ADD NEW Prenatal</span>
                </button>
            </div>

            <div class="data-table my-3 w-100 overflow-auto mx-0 px-0">
                <table id="PrenatalTable" data-id="<?php echo $patient_id; ?>"
                    class="table table-striped table-bordered my-3 mx-0 px-0">
                    <thead>
                        <tr>
                            <th class="">date</th>
                            <th class="">Dose Name</th>
                            <th class="">Dose Level</th>
                            <th class="">medications</th>
                            <th class="">action</th>
                        </tr>
                    </thead>
                    <tbody class='PrenatalTableBody'>
                    </tbody>
                </table>
            </div>

            <!-- CONSULTATION MODALS-->
            <?php include(ROOT_PATH . '/app/includes/modals/PrenatalModal.php'); ?>
        </div>
    </div>
</div>
