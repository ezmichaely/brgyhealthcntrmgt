...
<?php $title = 'Manage - Delivery Type';?>
...
<body>
    ...
    <main class="admin backend-main bg-primary overflow-x-hidden">
        <div class="d-flex justify-content-start align-items-start flex-row">
            ...
            <section class="main-container" id="main-container">
                    ...
                    <div class="mt-2">
                        <div class="add-button ">
                            ...
                            <button type="button" class="btn btn-success font-title fw-bold text-uppercase"
                                data-bs-toggle="modal" data-bs-target="#addDeliveryTypeModal">
                                <i class="fas fa-plus"></i>
                                <span>ADD Delivery TYPE</span>
                            </button>
                        </div>

                        <div class="data-table w-100 mt-3 overflow-auto">
                            <table id="DeliveryTypeTable" class="display table table-striped table-bordered">
                                <thead>
                                    <tr>
                                        <th>#</th>
                                        <th>name</th>
                ...
                <?php include(ROOT_PATH . '/app/includes/modals/DeliveryTypeModal.php'); ?>
            </section>
        </div>
    </main>
    <!-- end of main -->
    ...
    $(document).ready(function() {
        ...
        function getExistingData(start, limit) {
            $.ajax({
                url: '/bhcm.com/app/controllers/manage/crudDeliveryType.php',
                method: 'POST',
                dataType: 'text',
                data: {
                    key: 'getExistingData',
        ...
        $(document).on('click', '#getEdit', function(e) {
            e.preventDefault();
            var editDeliveryTypeBtn = $(this).data('id');
            //alert(per_id);
            $('#content-data').html('');
            $.ajax({
                url: '/bhcm.com/app/controllers/manage/crudDeliveryType.php',
                type: 'POST',
                data: 'editDeliveryTypeBtn=' + editDeliveryTypeBtn,
                dataType: 'html'
            }).done(function(data) {
                $('#content-data').html('');
